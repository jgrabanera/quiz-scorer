...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = [
            ...
            ['name' => 'Frances Seah A. Filog', 'school' => 'APAYAO SCIENCE HIGH SCHOOL', 'address' => 'Apayao'],
            ...
            ['name' => 'Adriane Jade B. Seling', 'school' => 'St. Louis High School of Balatoc, Inc.', 'address' => 'Benguet'],
            ['name' => 'Andrei John B. Monteflor', 'school' => 'San Jose School of La Trinidad Inc.', 'address' => 'Benguet'],
            ['name' => 'Vincent Angelo Angpao Toledo Paut', 'school' => 'International School of Asia and the Pacific Kalinga Campus', 'address' => 'Kalinga'],
